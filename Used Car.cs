...
{
    public class Used_Car : Car
    {
        public double Mileage { get; set; }

        /*public Used_Car(string make, string model, int year, decimal price, double mileage)
        {
            this.Make = make;
            this.Model = model;
            this.Year = year;
        ...
        //make constructor that pass values up to parent and add in our additional property/field
        ...
        {
            return new string($"\nPrinting Car Details\n--------------------\nMake: {this.Make}\tModel: {this.Model}\tYear: {this.Year}\tPrice: ${this.Price}\tMileage: {this.Mileage}");
        }
    }
}
